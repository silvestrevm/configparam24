...
import com.example.application.views.collaborativemasterdetail2.CollaborativeMasterDetail2View;
import com.example.application.views.collaborativemasterdetail3.CollaborativeMasterDetail3View;
...
public class MainLayout extends AppLayout {
    ...
    private AppNav createNavigation() {
        ...
        nav.addItem(new AppNavItem("Collaborative Master-Detail3", CollaborativeMasterDetail3View.class,
                LineAwesomeIcon.COLUMNS_SOLID.create()));
        nav.addItem(new AppNavItem("Collaborative Master-Detail2", CollaborativeMasterDetail2View.class,
                LineAwesomeIcon.COLUMNS_SOLID.create()));
