...
import com.example.application.data.service.ConfigurationParametersService;
...
@Route(value = "collaborative-master-detail/:configurationParametersID?/:action?(edit)", layout = MainLayout.class)
public class CollaborativeCollaborativeMasterDetailView extends Div implements BeforeEnterObserver {

    private final String CONFIGURATIONPARAMETERS_ID = "configurationParametersID";
    private final String CONFIGURATIONPARAMETERS_EDIT_ROUTE_TEMPLATE = "collaborative-master-detail/%s/edit";
    ...
    public CollaborativeCollaborativeMasterDetailView(ConfigurationParametersService configurationParametersService) {
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(CollaborativeCollaborativeMasterDetailView.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (configurationParametersId.isPresent()) {
            ...
            if (configurationParametersFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(CollaborativeCollaborativeMasterDetailView.class);
            }
        }
    }
